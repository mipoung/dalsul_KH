...
<script>
   ...
   // 실제 삭제 동작 함수
   function deleteConfirm(product_name) {
      ...
      $(".deleteBtn").click(function() {
         console.log("deleteBtn click");
          ...
          if (confirm("정말 삭제하시겠습니까?")) {
              ...
              const product_name = $(this).data("product-id");
      ...
      <table class="table table-bordered">
         ...
         <tbody>
            <c:forEach items="${cartList}" var="cartList">
               <tr id="cartItem-${cartList.product_name}" class="cart-item">
                  <td class="product_name" >${cartList.product_name}</td>
                  <td class="product_price-quantity">
                     <button type="button" class="btn btn-primary btn-sm minusBtn" data-product-id="${cartList.product_name}">-</button> 
                     <span class="product_price">${cartList.product_price}</span>
                     <button type="button" class="btn btn-primary btn-sm plusBtn" data-product-id="${cartList.product_name}">+</button>
                  </td>
                  <td class="quantity">${cartList.quantity}</td>
                  <td class="total"></td>
                  <td>
                     <button type="button" class="btn btn-danger btn-sm deleteBtn"
                        data-product-id="${cartList.product_name}">x</button>
                  </td>
               </tr>
            </c:forEach>
         </tbody>
