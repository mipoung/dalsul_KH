...
<body>
	<div class="container">
			<div class="input-form col-md-8 mx-auto certified_div">
...
제 1조 (목적)
이 약관은 담화컴퍼니 주식회사(전자상거래 사업자)(이하 "회사")가 운영하는 인터넷사이트 술담화(이하 "술담화")에서 제공하는 전자상거래 관련 서비스(이하 "서비스")를 이용함에 있어 술담화와 이용자의 권리, 의무 및 책임사항을 규정함을 목적으로 합니다.
※ 「PC통신, 스마트폰 앱, 무선 등을 이용하는 전자상거래에 대해서도 그 성질에 반하지 않는 한 준용합니다」

제 2조 (정의)
① "술담화"란 회사가 재화 또는 용역(이하 "재화 등"이라 함)을 이용자에게 제공하기 위하여 컴퓨터 등 정보통신설비를 이용하여 재화 등을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 서비스를 운영하는 사업자의 의미로도 사용합니다.
② "이용자"란 "술담화"에 접속하여 이 약관에 따라 "술담화"가 제공하는 서비스를 받는 회원 및 비회원을 말합니다.
③ "회원"이라 함은 "술담화"에 회원등록을 한 자로서, 계속적으로 "술담화"가 제공하는 서비스를 이용할 수 있는 자를 말합니다.
④ "비회원"이라 함은 회원에 가입하지 않고 "술담화"가 제공하는 서비스를 이용하는 자를 말합니다.
⑤ "콘텐츠"란 회사 또는 이용자가 서비스 상에 게시 또는 등록하는 모든 글, 사진, 동영상, 각종 파일, 링크, 회원소개 등(부호, 문자, 영상, 그림 등 그 형태를 불문합니다) 술담화 내에서 게시 또는 사용되는 일체의 정보를 말합니다.
  					</textarea>
...
담화컴퍼니 주식회사(이하 “회사”)는 개인정보 보호 관련 법령에 따라 고객의 개인정보를 보호하고 이와 관련한 고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과 같이 개인정보 처리방침을 수립·공개합니다.
