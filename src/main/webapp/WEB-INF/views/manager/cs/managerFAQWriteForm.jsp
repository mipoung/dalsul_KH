...
<body>
	...
	<div class="container mt-4">
    	...
    	<form action="/manager/cs/managerFAQInsert" method="post" class="container">
        	<!-- 입력 폼 -->
        	<div class="form-group">
        		<label for="faq_title">제목:</label>
        		<input type="text" id="faq_title" name="faq_title" required class="form-control"><br>
			</div>
			<div class="form-group">
        		<label for="faq_question">질문:</label>
        		<textarea id="faq_question" name="faq_question" required class="form-control"></textarea><br>
			</div>
			<div class="form-group">
        		<label for="faq_answer">답변:</label>
        		<textarea id="faq_answer" name="faq_answer" required class="form-control"></textarea><br>
			</div>
        <!-- 버튼 -->
