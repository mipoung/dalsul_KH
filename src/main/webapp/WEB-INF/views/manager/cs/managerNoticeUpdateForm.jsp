...
<body>
    ...
    <form action="/manager/cs/managerNoticeUpdate" method="post">
        <!-- 입력 폼 -->
        ...
        <div class="form-group">
        	<input type="text" id="notice_title" name="notice_title" value='${updateData.notice_title}' required class="form-control"><br>
		</div>
		<div class="form-group">
        	<label for="notice_subject">내용:</label>
        	<textarea id="notice_subject" name="notice_subject" required class="form-control">${updateData.notice_subject}</textarea><br>
		</div>
