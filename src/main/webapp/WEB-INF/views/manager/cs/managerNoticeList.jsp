...
<title>notice</title>
        <script>
            $(function(){
                  ...
                  $(".goDetail").click(function(){
                     ...
                     $("#detailForm").attr({
                         "method" : "get", 
                         "action" : "/manager/cs/managerNoticeDetail"
                     });
                     $("#detailForm").submit();
                ...
                function goPage(){
                    ...
                    $("#f_search").attr({
                        "method" : "get",
                        "action" : "/manager/cs/managerNoticeList"
                    });
                    $("#f_search").submit();
   ...
   <!-- 여기서 작성하시면 됩니다. -->
			...
			<tbody>
				...
				<c:forEach items="${noticeList}" var="notice">
					<tr>
						...
						<td><a href="/manager/cs/managerNoticeDetail?notice_no=${notice.notice_no}">
	...
	<!-- 작성하기 -->
	<a href="/manager/cs/managerNoticeWriteForm" class="btn btn-primary" style="margin-bottom: 15px">작성하기</a>
