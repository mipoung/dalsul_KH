...
<body>
    ...
    <!-- 주소지 입력 API -->
        ...
        <input type="text" id="jibunAddress" placeholder="지번주소" onclick="execDaumPostcode()" readonly="readonly" name="jibunAddress">
        ...
        <input type="text" id="extraAddress" onclick="execDaumPostcode()" placeholder="참고항목" readonly="readonly" name="extraAddress"><br>
    </div><!-- 주소입력 컨테이터 종료 -->
</body>
</html>