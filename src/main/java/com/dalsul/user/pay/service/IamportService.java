...
//
//			IamprotDto token = restTemplate.postForObject("https://api.iamport.kr/users/getToken", entity,
//					IamprotDto.class);
...
//
//			BuyerInforDto buyerInfor = restTemplate.postForObject("https://api.iamport.kr/payments/" + imp_uid + "",
...
//			cancleBuyDto cancle = restTemplate.postForObject("https://api.iamport.kr/payments/cancel", entity,
//					cancleBuyDto.class);
//
